...
mixin _$Workout {
  ...
  double? get estimatedDistanceMeters => throw _privateConstructorUsedError;
...
class _$WorkoutImpl implements _Workout {
  ...
  @override
  String toString() {
    return 'Workout(id: $id, userId: $userId, activityType: $activityType, startedAt: $startedAt, endedAt: $endedAt, distanceKm: $distanceKm, durationMin: $durationMin, avgSpeedKmh: $avgSpeedKmh, calories: $calories, mode: $mode, stepCount: $stepCount, strideLength: $strideLength, estimatedDistanceMeters: $estimatedDistanceMeters)';
  }
