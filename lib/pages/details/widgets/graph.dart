...
class _GraphAreaState extends State<GraphArea>
  ...
  List<DataPoint> data = [
    DataPoint(day: 1, steps: Random().nextInt(10000)),
    DataPoint(day: 2, steps: Random().nextInt(10000)),
    DataPoint(day: 3, steps: Random().nextInt(10000)),
    DataPoint(day: 4, steps: Random().nextInt(10000)),
    DataPoint(day: 5, steps: Random().nextInt(10000)),
    DataPoint(day: 6, steps: Random().nextInt(10000)),
    DataPoint(day: 7, steps: Random().nextInt(10000)),
  ];
...
class GraphPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(offsets[0], 15 * _dotSize.value, dotOutlinePaint);
    canvas.drawCircle(offsets[0], 6 * _dotSize.value, dotCenter);
  }
